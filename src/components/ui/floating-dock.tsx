...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "hidden h-16 items-end gap-4 rounded-2xl bg-neutral-900 border-[0.5px] border-neutral-800 px-4 pb-3 md:flex",
        className
      )}
    >
      {items.map((item, idx) => (
  ...
  return (
    <div>
      ...
      >
        ...
        <motion.div
          onClick={() => onSelect({ title, icon, description, description2 })}
